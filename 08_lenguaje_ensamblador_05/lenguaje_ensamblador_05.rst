...
|Mnemonic     |Clck|Siz|SZHPNC|  OP-Code   |    Description      |        Notes         |
+-------------+----+---+------+------------+---------------------+----------------------+
|LDD          | 16 | 2 |--0x0-|ED A8       |Load and Decrement   |(DE)=(HL),HL=HL-1,#   |
+-------------+----+---+------+------------+---------------------+----------------------+
|LDDR         |21/1| 2 |--000-|ED B8       |Load, Dec., Repeat   |LDD till BC=0         |
+-------------+----+---+------+------------+---------------------+----------------------+
|LDI          | 16 | 2 |--0x0-|ED A0       |Load and Increment   |(DE)=(HL),HL=HL+1,#   |
+-------------+----+---+------+------------+---------------------+----------------------+
...
|Mnemonic     |Clck|Siz|SZHPNC|  OP-Code   |    Description      |        Notes         |
+-------------+----+---+------+------------+---------------------+----------------------+
|NEG          | 8  | 2 |xxxV1x|ED 44       |Negate               |A=-A                  |
+-------------+----+---+------+------------+---------------------+----------------------+
|NOP          | 4  | 1 |------|00          |No Operation         |                      |
+-------------+----+---+------+------------+---------------------+----------------------+
|OR r         | 4  | 1 |xxxP00|B0+rb       |Logical inclusive OR |A=Avs                 |
+-------------+----+---+------+------------+---------------------+----------------------+
|OR N         | 7  | 2 |      |F6 XX       |                     |                      |
+-------------+----+---+------+------------+---------------------+----------------------+
|OR (HL)      | 7  | 1 |      |B6          |                     |                      |
...
+---------------+----------+-----+--------+--------------+-----------------------+------------------------+
| OTDR          | 21/01/22 | 2   | ?1??1- | ED BB        | Output, Dec., Repeat  | OUTD till B=0          |
+---------------+----------+-----+--------+--------------+-----------------------+------------------------+
| OUTI          | 16       | 2   | ?x??1- | ED A3        | Output and Increment  | (C)=(HL),HL=HL+1,B=B-1 |
+---------------+----------+-----+--------+--------------+-----------------------+------------------------+
| OTIR          | 21/01/22 | 2   | ?1??1- | ED B3        | Output, Inc., Repeat  | OUTI till B=0          |
+---------------+----------+-----+--------+--------------+-----------------------+------------------------+
...
| Mnemonic   | Clck | Siz | SZHPNC      | OP-Code  | Description           | Notes                  |
+============+======+=====+=============+==========+=======================+========================+
| RLA        | 4    | 1   | --0-0x      | 17       | Rotate Left Acc.      | A={CY,A}<-             |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RL r       | 8    | 2   | xx0P0x      | CB 10+rb | Rotate Left           | m={CY,m}<-             |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RL (HL)    | 15   | 2   | CB 16       |          |                       |                        |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
...
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RLCA       | 4    | 1   | --0-0x      | 07       | Rotate Left Cir. Acc. | A=A<-                  |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RLC r      | 8    | 2   | xx0P0x      | CB 00+rb | Rotate Left Circular  | m=m<-                  |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RLC (HL)   | 15   | 2   | CB 06       |          |                       |                        |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
...
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RLD        | 18   | 2   | xx0P0-      | ED 6F    | Rotate Left 4 bits    | {A,(HL)}={A,(HL)}<- ## |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RRA        | 4    | 1   | --0-0x      | 1F       | Rotate Right Acc.     | A=->{CY,A}             |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RR r       | 8    | 2   | xx0P0x      | CB 18+rb | Rotate Right          | m=->{CY,m}             |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RR (HL)    | 15   | 2   | CB 1E       |          |                       |                        |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
...
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RRCA       | 4    | 1   | --0-0x      | 0F       | Rotate Right Cir.Acc. | A=->A                  |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RRC r      | 8    | 2   | xx0P0x      | CB 08+rb | Rotate Right Circular | m=->m                  |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RRC (HL)   | 15   | 2   | CB 0E       |          |                       |                        |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
...
+------------+------+-----+-------------+----------+-----------------------+------------------------+
| RRD        | 18   | 2   | xx0P0-      | ED 67    | Rotate Right 4 bits   | {A,(HL)}=->{A,(HL)} ## |
+------------+------+-----+-------------+----------+-----------------------+------------------------+
...
| Mnemonic     | Clck | Siz | SZHPNC          | OP-Code           | Description           | Notes        |
+==============+======+=====+=================+===================+=======================+==============+
| SBC r        | 4    | 1   | xxxV1x          | 98+rb             | Subtract with Carry   | A=A-s-CY     |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SBC A,N      | 7    | 2   | DE XX           |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SBC (HL)     | 7    | 1   | 9E              |                   |                       |              |
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SBC HL,BC    | 15   | 2   | xx?V1x          | ED 42             | Subtract with Carry   | HL=HL-ss-CY  |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SET b,r      | 8    | 2   | ------          | CB C0+8xb+rb      | Set bit               | m=mv{2^b}    |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SET b,(HL)   | 15   | 2   | CB C6+8xb       |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SET b,(IX+N) | 23   | 4   | DD CB XX C6+8xb |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SET b,(IY+N) | 23   | 4   | FD CB XX C6+8xb |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SLA r        | 8    | 2   | xx0P0x          | CB 20+rb          | Shift Left Arithmetic | m=mx2        |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SLA (HL)     | 15   | 2   | CB 26           |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SRA r        | 8    | 2   | xx0P0x          | CB 28+rb          | Shift Right Arith.    | m=m/2        |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SRA (HL)     | 15   | 2   | CB 2E           |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SLL r        | 8    | 2   | xx0P0x          | CB 30+rb          | Shift Left Logicalx   | m={0,m,CY}<- |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SRL r        | 8    | 2   | xx0P0x          | CB 38+rb          | Shift Right Logical   | m=->{0,m,CY} |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SRL (HL)     | 15   | 2   | CB 3E           |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SUB r        | 4    | 1   | xxxV1x          | 90+rb             | Subtract              | A=A-s        |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SUB N        | 7    | 2   | D6 XX           |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| SUB (HL)     | 7    | 1   | 96              |                   |                       |              |
...
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| XOR r        | 4    | 1   | xxxP00          | A8+rb             | Logical Exclusive OR  | A=Axs        |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| XOR N        | 7    | 2   | EE XX           |                   |                       |              |
+--------------+------+-----+-----------------+-------------------+-----------------------+--------------+
| XOR (HL)     | 7    | 1   | AE              |                   |                       |              |
